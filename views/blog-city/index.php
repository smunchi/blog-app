...
/* @var $searchModel app\models\BlogCitySearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Blog Cities');
$this->params['breadcrumbs'][] = $this->title;
$model = new \app\models\BlogCity();
...
Modal::end();
?>
<div class="blog-city-index">

    <?php Pjax::begin(); ?>
    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>

    <p>
        <?= Html::a(Yii::t('app', 'Create Blog City'), ['create'], ['class' => 'btn btn-success']) ?>
    </p>
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            'name',
            'title',
            ['attribute' => 'country.name', 'label' => 'Country'],
            'created_at',
            [
