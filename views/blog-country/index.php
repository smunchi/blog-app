...
/* @var $searchModel app\models\BlogCountrySearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Blog Countries');
$this->params['breadcrumbs'][] = $this->title;
$model = new \app\models\BlogCountry();
...
Modal::end();
?>
<div class="blog-country-index">

    <?php Pjax::begin(); ?>
    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>

    <p>
        <?= Html::a(Yii::t('app', 'Create Blog Country'), ['create'], ['class' => 'btn btn-success']) ?>
    </p>
