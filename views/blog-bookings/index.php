...
/* @var $searchModel app\models\BlogBookingsSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Blog Bookings');
$this->params['breadcrumbs'][] = $this->title;
$model = new \app\models\BlogBookings();
...
Modal::end();
?>
<div class="blog-bookings-index">

    <?php Pjax::begin(); ?>
    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>

    <p>
        <?= Html::a(Yii::t('app', 'Create Blog Bookings'), ['create'], ['class' => 'btn btn-success']) ?>
    </p>
